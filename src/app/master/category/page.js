...
export default function MasterCategoryPage() {
    ...
    const handleAddSubmit = async (e) => {
        e.preventDefault()
        if(!formData.name.trim()) return toast.error("Kategori tidak boleh kosong!")
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            ...
            toast.success(`Kategori "${currentCategory.name}" berhasil dihapus!`)
        ...
        <div className="flex flex-col h-full">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
                        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                            <h3 className="font-bold text-gray-800">Tambah Kategori Baru</h3>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        placeholder="Contoh: Alat Suntik"
                                        autoFocus
                                    />
                                </div>
                            </div>
            ...
            {isEditOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
                        <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                            <h3 className="font-bold text-gray-800">Edit Kategori</h3>
            ...
            {isDeleteOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden p-6 text-center animate-in fade-in zoom-in duration-200 scale-95">
                        ...
                        <h3 className="font-bold text-xl text-gray-800 mb-2">Hapus Kategori?</h3>
                        <p className="text-gray-500 text-sm mb-6">
                            Anda yakin ingin menghapus kategori <span className="font-bold text-gray-800">"{currentCategory?.name}"</span>? Tindakan ini tidak dapat dibatalkan.
                        </p>
